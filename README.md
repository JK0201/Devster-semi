...
## Outro
  <details>
    ...
    <ul>
      ...
      <li>모듈화를 하지 않아 에러 발생 시 원인을 찾거나 팀원들에게 제가 작성한 코드를 설명하는 데 어려움을 겪는 경우가 많았습니다. 이로 인해 개발 시간이 증가하고 최종 결과물의 퀄리티도 떨어졌습니다. 이를 통해 기능 분리와 레이어 분리의 중요성을 깨달았으며, 앞으로는 이러한 원칙을 준수하여 개발 시간을 단축하고 효율성을 높이는 데 주력하겠습니다.</li>
    </ul>
  </details>
<br>
