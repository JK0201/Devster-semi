...
<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Orbitron&weight=500&pause=10000&color=58A6FF&center=true&random=false&width=435&lines=Devster v1.0" alt="Typing SVG" />
  </a>
...
## 문제점 및 개선안
  ...
  <details>
    ...
    <ul>
      ...
      <li>소셜 로그인 : 로그인 처리를 서버 측으로 이전하여 보안성 강화</li>
...
## Outro
  <details>
    ...
    <ul>
      ...
      <li>모듈화를 하지 않아 에러 발생 시 원인을 찾거나 팀원들에게 제가 작성한 코드를 설명하는 데 어려움을 겪는 경우가 많았습니다. 이로 인해 개발 시간이 증가하고 최종 결과물의 퀄리티도 떨어지는 느낌을 강하게 받았습니다. 이를 통해 기능 분리와 레이어 분리의 중요성을 깨달았으며, 앞으로는 이러한 원칙을 준수하여 개발 시간을 단축하고 효율성을 높이는 데 주력할 것입니다.</li>
      <li>Drag & Drop 기능을 직접 구현하면서 이벤트 리스너와 DOM 조작에 대한 이해도를 높일 수 있었습니다.</li>
      <li>비밀번호 암호화 및 유효성 검사를 통해 보안의 중요성을 다시 한번 느낄 수 있었고, 특히 클라이언트에서만 유효성 검사와 소셜 로그인을 처리 했을 때의 보안 취약점을 경험할 수 있었습니다. HTTP 요청 조작 및 무차별 대입(Brute Force) 공격을 방지하기 위해 서버 측에서도 철저한 유효성 검사를 수행해야 한다는 것을 배울 수 있었습니다.</li>
    </ul>
  </details>
<br>
