    ...
    <div class="inputdiv">
        ...
        <div id="cmdisplay">
            <div class="membermail">
                ...
                <div class="input-group">
                    <input type="email" placeholder="Email@example.com" id="cm_email">
            ...
            <div class="input__block">
                <b>회&nbsp;사&nbsp;명</b>
                <input type="text" placeholder="Company" class="input" id="cm_compname" required/>
                <span id="compnamechkicon">　　</span>
            </div>
            <div class="membermail">
                <b>주&nbsp;소&nbsp;&&nbsp;우&nbsp;편&nbsp;번&nbsp;호</b>
                <div class="input-group">
                    <input type="text" placeholder="Address" id="addr" readonly required style="cursor:default"/>
                    <button class="memberbtn" id="postbtn">주&nbsp;소&nbsp;찾&nbsp;기</button>
                </div>
            </div>
            <div class="input__block">
                <input type="text" placeholder="Additional" class="input" id="addrinfo" required
                       style="width:50%; float:left; margin-left: 5%;"/>
                <input type="text" placeholder="Postal Code" class="input" id="cm_post" readonly required
                       style="width:34%; cursor:default"/>
                <span id="addrchkicon">　　</span>
            </div>
            <div class="input__block">
                <b>전&nbsp;화&nbsp;번&nbsp;호&nbsp;(대&nbsp;표&nbsp;전&nbsp;화)</b>
                <input type="tel" placeholder="Phone number" class="input" id="cm_tele" required/>
                <span id="cpchkicon">　　</span>
            </div>
            <div class="input__block">
                <b>이&nbsp;름&nbsp;(담&nbsp;당&nbsp;자)</b>
                <input type="text" placeholder="Name" class="input" id="cm_name" required/>
                <span id="namechkicon">　　</span>
            </div>
            <div class="input__block">
                <b>휴&nbsp;대&nbsp;폰&nbsp;(담&nbsp;당&nbsp;자)</b>
                <input type="tel" placeholder="Cellphone" class="input" id="cm_cp" required/>
...
<script>
                    ...
                    if (res.result == "no") {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                if (code == "01") {
                                    $("#regchk").html("<i class='bi bi-check' style='color:green;'></i>" +
                                        "정상적인 사업자등록번호 입니다");
                                    regcheck = true;
                                } else if (code == "02") {
                                    $("#regchk").html("<i class='bi bi-x' style='color:red;'></i>" +
    ...
    //phone check
    $(document).on("keyup", "#cm_cp", function () {
        let phonenum = $("#cm_cp").val();
    ...
    $(document).on("mouseover keyup", function () {
        ...
        if (emailcheck && emailvalid && emailcode && passcheck && passvalid && compname && compvalid && namevalid && phonecheck && cphonecheck && addrcheck && regfile) {
            console.log("true");
        } else {
    ...
    $("#uploadbtn").click(function () {
        ...
        if (!emailcheck || !emailvalid) {
            ...
            formData.append("cm_reg", $("#cm_reg").val());
