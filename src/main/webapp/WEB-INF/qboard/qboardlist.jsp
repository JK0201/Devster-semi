...
<div class="qb_wrap">
    ...
    <div class="headbox">
        <h4 class="boardname">
            <div class="yellowbar" style="margin-right: 10px;">&nbsp;</div>질문게시판
        </h4>
...
<br>
<button id="myWriteBtn" type="button" onclick="location.href='./writeform'"><i class="bi bi-pencil-square"></i></button>
